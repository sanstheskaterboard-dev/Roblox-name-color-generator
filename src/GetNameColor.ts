...
// Generate the chat colors array
...
// Computes the numeric value for a username
...
// Returns the Color object for a given username
let GetNameColor = (username: string, version_?: number): Color => {
    ...
    let value = cmv - Math.floor(cmv / len) * len; // Lua-style modulus handling for negatives
